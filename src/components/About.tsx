        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-slide-up">
            ...
            <div className="flex flex-row gap-4 justify-center mb-6">
              <img src="/project1.jpg" alt="Project 1" className="w-28 h-28 rounded-xl object-cover shadow-md border-2 border-purple-200" />
              <img src="/event1.jpg" alt="Event 1" className="w-28 h-28 rounded-xl object-cover shadow-md border-2 border-pink-200" />
            </div>
            <p className="text-lg text-purple-700 font-semibold mb-4">
              Hi, I'm Muskan Bharti, a 2nd year CSE student at Government Engineering College Bhojpur. I love building projects, learning new things, and collaborating with others.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-6 animate-slide-right">
              <div>
                ...
                {/* Journey Images Gallery removed */}
