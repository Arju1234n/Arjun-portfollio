            ...
            <div className="text-center lg:text-left animate-slide-right">
              <div className="mb-8">
                ...
                <p className="text-xl text-purple-200 mb-2 animate-slide-up" style={{ animationDelay: '0.1s' }}>
                  Hi, I'm Muskan Bharti, a 2nd year CSE student at Government Engineering College Bhojpur.
                </p>
                <p className="text-lg text-purple-100 mb-6 animate-slide-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center justify-center lg:justify-start space-x-2 text-purple-200 mb-8 animate-slide-up" style={{ animationDelay: '0.4s' }}>
                  ...
                  <span className="text-lg">Patna, India</span>
                </div>
              </div>
